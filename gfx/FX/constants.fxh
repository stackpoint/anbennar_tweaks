...
static const float  MAP_LIGHT_INTENSITY   		= 1.6f;
...
static const float 	TREE_SEASON_FADE_TWEAK 		= 3.5f;
...
static const float 	WATER_TILE					= 0.1f;
...
static const float 	FOG_MAX 					= 0.6f;
static const float3 FOG_COLOR 					= float3( 1.1f, 1.1f, 1.5f );
